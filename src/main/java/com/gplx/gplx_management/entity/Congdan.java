...
@Table(name = "congdan", uniqueConstraints = {
                @UniqueConstraint(name = "public_id", columnNames = { "public_id" }),
                @UniqueConstraint(name = "CCCD", columnNames = { "CCCD" }),
                @UniqueConstraint(name = "SoDienThoai", columnNames = { "SoDienThoai" }),
...
public class Congdan {
        ...
        @Column(name = "GiayKhamSucKhoe", length = 255)
